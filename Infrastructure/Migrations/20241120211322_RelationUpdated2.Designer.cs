...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20241120211322_RelationUpdated2")]
    partial class RelationUpdated2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.AggregateModels.Respuesta", b =>
                {
                    ...
                    b.Property<Guid>("ProyectoidNavigationId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ProyectoidNavigationId");
            ...
            modelBuilder.Entity("Domain.AggregateModels.Respuesta", b =>
                {
                    ...
                    b.HasOne("Domain.AggregateModels.Proyecto", "ProyectoidNavigation")
                        .WithMany()
                        .HasForeignKey("ProyectoidNavigationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
