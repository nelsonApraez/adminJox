namespace Api.Controllers.Controllers
{
    ...
    /// <summary>
    /// Api Para Exponer los Metodos de la Entidad [Conversation]
    /// </summary>
    public partial class ConversationController : BaseControllerDm<Application.Features.Models.Dto.ConversationDto, Domain.AggregateModels.Conversation>
    {
        ...
        ///         200OK Lista de Registros de la Entidad [Conversation]
        ...
        /// </remarks>
        /// <response code="200">Retorna la Lista de Registros de la Entidad [Conversation]</response>
        ...
        [HttpGet]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(List<Application.Features.Models.Dto.ConversationDto>))]
        ...
        /// <returns>
        /// Retorna un response HTTP con StatusCodes
        ///         200OK Lista de Registros de la Entidad [Conversation] y Un objeto con los datos de la paginación
        ///         400BadRequest Sí ocurrió una falla, validación o error controlado
        ///         500InternalServerError Sí ocurrió una falla o error NO controlado
        ///         403Forbidden Sí no tiene permisos para ejecutar la acción
        ///         401Unauthorized Sí no esta autenticado
        ...
        /// Entidad [Conversation]
        /// </remarks>
        /// <response code="200">Retorna Un Objeto Compuesto, Lista de Registros de la Entidad [Conversation] y Un objeto con los datos de la paginación</response>
        /// <response code="400">Sí ocurrió una falla, validación o error controlado</response>
        /// <response code="500">Sí ocurrió una falla o error NO controlado</response>
        /// <response code="403">Sí no tiene permisos para ejecutar la acción</response>
        /// <response code="401">Sí no esta autenticado</response>
        [HttpGet("GetPage")]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(CustomList<Application.Features.Models.Dto.ConversationDto>))]
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(ResponseApi))]
        [ProducesResponseType(StatusCodes.Status500InternalServerError, Type = typeof(ResponseApi))]
        [ProducesResponseType(StatusCodes.Status403Forbidden, Type = typeof(ResponseApi))]
        [ProducesResponseType(StatusCodes.Status401Unauthorized)]
        ...
        /// <summary>
        /// Obtener un registro por [{id}] de la Entidad [Conversation]
        /// </summary>
        /// <param name="id">id Del Registro</param>
        /// <returns>
        /// Retorna un response HTTP con StatusCodes
        ///         200OK Registro encontrado por por [{id}] de la Entidad (Conversation)
        ///         404NotFound Sí no se encuentra un registro por [{id}] de la Entidad (Conversation)
        ///         400BadRequest Sí ocurrió una falla, validación o error controlado
        ///         500InternalServerError Sí ocurrió una falla o error NO controlado
        ///         403Forbidden Sí no tiene permisos para ejecutar la acción
        ///         401Unauthorized Sí no esta autenticado
        ...
        /// Entidad [Conversation]
        /// </remarks>
        /// <response code="200">Retorna Un Registro encontrado por [{id}] de la Entidad (Conversation)</response>
        /// <response code="404">Sí no se encuentra un registro por [{id}] de la Entidad (Conversation)</response>
        /// <response code="400">Sí ocurrió una falla, validación o error controlado</response>
        /// <response code="500">Sí ocurrió una falla o error NO controlado</response>
        /// <response code="403">Sí no tiene permisos para ejecutar la acción</response>
        /// <response code="401">Sí no esta autenticado</response>
        [HttpGet("{id}")]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(Application.Features.Models.Dto.ConversationDto))]
        ...
        public Task<IActionResult> Get(string id)
        {
		   ...
		   /// <summary>
        /// recibe una lista de Conversations para eliminar
        /// </summary>
        ...
        [ProducesResponseType(StatusCodes.Status403Forbidden, Type = typeof(ResponseApi))]
        [ProducesResponseType(StatusCodes.Status401Unauthorized)]
        public async Task<IActionResult> DeleteListPostAsync([FromBody] IList<Application.Features.Models.Dto.ConversationDto> listObjBase)
        {
            var validate = await _mediator.Send(new Application.Features.Commands.DeleteListEntitiesAsyncCommand<Application.Features.Models.Dto.ConversationDto, Domain.AggregateModels.Conversation> (listObjBase, nameof(Application.Features.Models.Dto.ConversationDto.Sessionid )));
            if (validate?.Count > 0)
            {
		   ...
		   /// <summary>
        /// Eliminar un registro por [{id}] de la Entidad Conversation
        /// </summary>
        /// <param name="id">id Del Registro de Conversation</param>
        /// <returns>
        /// Retorna un response HTTP con StatusCodes
        ///         200OK Respuesta de la operacion y el Objeto de ResponseApi
        ///         404NotFound Sí no se encuentra un registro por [{id}] para eliminar de la Entidad  Conversation
        ///         400BadRequest Sí ocurrió una falla, validación o error controlado
        ///         500InternalServerError Sí ocurrió una falla o error NO controlado
        ///         403Forbidden Sí no tiene permisos para ejecutar la acción
        ///         401Unauthorized Sí no esta autenticado
        ...
        {
            var objBase = await _mediator.Send(new Application.Features.Queries.GetEntityAsyncById<Application.Features.Models.Dto.ConversationDto , Domain.AggregateModels.Conversation>(id) );
            return await DeleteListPostAsync(new List<Application.Features.Models.Dto.ConversationDto>() {  objBase ?? new Application.Features.Models.Dto.ConversationDto() { Id ="-1",Sessionid = string.Empty}}  );
        }
    }
