namespace Api.Controllers
{
    ...
    /// <summary>
    /// API to expose the methods for the entity [AuthorizationPermissions]
    /// </summary>
    public partial class AuthorizationPermissionsController : BaseControllerDm<Application.Features.Models.Dto.AuthorizationPermissionsDto, Domain.AggregateModels.AuthorizationPermissions>
    {
        /// <summary>
        ...
        ///         200OK List of Entity Records [AuthorizationPermissions]
        ...
        /// </returns>
        /// <remarks>
        /// Entity [AuthorizationPermissions]
        /// </remarks>
        /// <response code="200">Returns a List of Entity Records [AuthorizationPermissions]</response>
        ...
        [HttpGet]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(List<Application.Features.Models.Dto.AuthorizationPermissionsDto>))]
        ...
        /// <returns>
        /// Returns an HTTP response with StatusCodes
        ///         200OK List of Entity Records [AuthorizationPermissions] and an object with the pagination data
        ///         400BadRequest If a failure, validation or controlled error occurred
        ///         500InternalServerError If a failure or error occurred that was NOT controlled
        ///         403Forbidden If you do not have permissions to execute the action
        ///         401Unauthorized If you are not authenticated
        ...
        /// Entity [AuthorizationPermissions]
        /// </remarks>
        /// <response code="200">Returns a composite object, List of Entity Records [AuthorizationPermissions] and an object with the pagination data</response>
        /// <response code="400">If a failure, validation or controlled error occurred</response>
        /// <response code="500">If a failure or error occurred that was NOT controlled</response>
        /// <response code="403">If you do not have permissions to execute the action</response>
        /// <response code="401">If you are not authenticated</response>
        [HttpGet("GetPage")]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(CustomList<Application.Features.Models.Dto.AuthorizationPermissionsDto>))]
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(ResponseApi))]
        [ProducesResponseType(StatusCodes.Status500InternalServerError, Type = typeof(ResponseApi))]
        [ProducesResponseType(StatusCodes.Status403Forbidden, Type = typeof(ResponseApi))]
        [ProducesResponseType(StatusCodes.Status401Unauthorized)]
        ...
        /// <summary>
        /// Get a record by [{id}] from Entity [AuthorizationPermissions]]
        /// </summary>
        /// <param name="id">Record id</param>
        /// <returns>
        /// Returns an HTTP response with StatusCodes
        ///         200OK Record found by by [{id}] of the Entity [AuthorizationPermissions])
        ///         404NotFound If a record is not found for [{id}] of the Entity [AuthorizationPermissions]
        ///         400BadRequest If a failure, validation or controlled error occurred
        ///         500InternalServerError If a failure or error occurred that was NOT controlled
        ///         403Forbidden If you do not have permissions to execute the action
        ///         401Unauthorized If you are not authenticated
        ...
        /// Entity [AuthorizationPermissions]
        /// </remarks>
        /// <response code="200">Returns A Record found by [{id}] of Entity [AuthorizationPermissions]</response>
        /// <response code="404">If a record is not found for [{id}] of the Entity [AuthorizationPermissions]</response>
        /// <response code="400">If a failure, validation or controlled error occurred</response>
        /// <response code="500">If a failure or error occurred that was NOT controlled</response>
        /// <response code="403">If you do not have permissions to execute the action</response>
        /// <response code="401">If you are not authenticated</response>
        [HttpGet("{id}")]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(Application.Features.Models.Dto.AuthorizationPermissionsDto))]
        ...
        /// <summary>
        /// Receives a list of AuthorizationPermissions to delete
        /// </summary>
        ...
        [ProducesResponseType(StatusCodes.Status403Forbidden, Type = typeof(ResponseApi))]
        [ProducesResponseType(StatusCodes.Status401Unauthorized)]
        public async Task<IActionResult> DeleteListPostAsync([FromBody] IList<Application.Features.Models.Dto.AuthorizationPermissionsDto> listObjBase)
        {            
            var validate = await _mediator.Send(new Application.Features.Commands.DeleteListEntitiesAsyncCommand<Application.Features.Models.Dto.AuthorizationPermissionsDto, Domain.AggregateModels.AuthorizationPermissions> (listObjBase, nameof(Application.Features.Models.Dto.AuthorizationPermissionsDto.Id )));
            if (validate?.Count > 0)
            {
        ...
        /// <summary>
        /// Deletes a record by [{id}] from Entity AuthorizationPermissions
        /// </summary>
        ...
        {
            var objBase = await _mediator.Send(new Application.Features.Queries.GetEntityAsyncById<Application.Features.Models.Dto.AuthorizationPermissionsDto, Domain.AggregateModels.AuthorizationPermissions>(id) );
            return await DeleteListPostAsync(new List<Application.Features.Models.Dto.AuthorizationPermissionsDto>() {  objBase ?? new Application.Features.Models.Dto.AuthorizationPermissionsDto() { Id =-1}}  );
        }
    }
}
